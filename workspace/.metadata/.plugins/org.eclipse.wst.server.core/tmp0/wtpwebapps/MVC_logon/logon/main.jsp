...
<body onLoad="focusIt();" bgcolor="<%=bodyback_c%>">
  <table width=500 cellpadding="0" cellspacing="0"  align="center" border="1" >
      <tr>
       ...
       <form name="inform" method="post" action="loginPro.go"  onSubmit="return checkIt();">
       ...
       <table width=500 cellpadding="0" cellspacing="0"  align="center" border="1" >
         <tr>
           ...
           <td rowspan="3" bgcolor="<%=value_c%>" align="center">
             ...
             방문하셨습니다
             <form  method="post" action="logout.go"> 
             <input type="submit"  value="로그아웃">
             <input type="button" value="회원정보변경" onclick="javascript:window.location='modify.go'">
             </form>
         </td>
        </tr>
       <tr >
